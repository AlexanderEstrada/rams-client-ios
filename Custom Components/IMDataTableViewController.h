...
@interface IMDataTableViewController : IMTableViewController <NSFetchedResultsControllerDelegate, UITableViewDataSource, UITableViewDelegate>

@property (nonatomic, readwrite) BOOL searchSupport;
