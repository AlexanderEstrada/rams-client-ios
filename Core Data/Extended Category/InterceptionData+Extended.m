...
+ (InterceptionData *)dataWithDictionary:(NSDictionary *)dictionary inManagedObjectContext:(NSManagedObjectContext *)context
{
    @try {
        ...
        data.iomOffice = [IomOffice officeWithDictionary:dictionary[kInterceptionIOMOffice] inManagedObjectContext:context];        
        data.interceptionLocation = [InterceptionLocation locationWithDictionary:dictionary[kInterceptionLocation] inManagedObjectContext:context];
        data.iomOfficer = [IomOfficer officerWithDictionary:dictionary[kInterceptionIOMOfficer] inManagedObjectContext:context];
        data.immigrationOfficer = [ImmigrationOfficer officerWithDictionary:dictionary[kInterceptionImmigrationOfficer] inManagedObjectContext:context];
        data.policeOfficer = [PoliceOfficer officerWithDictionary:dictionary[kInterceptionPoliceOfficer] inManagedObjectContext:context];
